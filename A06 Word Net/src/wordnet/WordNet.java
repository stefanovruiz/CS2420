...
public class WordNet {
	...
	SAP sap;
	   ...
	   public WordNet(String synsets, String hypernyms){
		   ...
		   sap = new SAP(digraph);
		   if(!sap.isRootedDAG()) throw new java.lang.IllegalArgumentException("hypernyms not rooted DAG");
	   ...
	   public int distance(String nounA, String nounB){
		   ...
		   if(wordToIntMap.get(nounA)==null||wordToIntMap.get(nounB)==null) throw new java.lang.NullPointerException();
